...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    edges: [edge([1, 1], [1, 3]), edge([1, 1], [3, 1]), edge([1, 3], [2, 2]), edge([2, 2], [3, 3])],
    tubeFactor: 0.55,
    gooStd: 9,
    gooThreshold: 22,
  },
  {
    ...
    label: 'Namche Loop',
    nodes: [node(1, 1), node(1, 3), node(2, 2), node(3, 1), node(3, 3)],
    edges: [edge([1, 1], [1, 3]), edge([1, 3], [3, 3]), edge([3, 1], [3, 3]), edge([2, 2], [3, 1])],
    tubeFactor: 0.55,
    gooStd: 9,
    gooThreshold: 22,
  },
  ...
  },
  {
    ...
    edges: [edge([1, 1], [1, 3]), edge([1, 1], [3, 1]), edge([1, 3], [3, 3]), edge([3, 1], [3, 3])],
  },
  {
    id: 'node',
    label: 'Node',
...
/** The current Namche mark. Kept explicit so array order stays an API detail. */
export const DEFAULT_PRESET_ID = 'loop'

/** Presets offered as buttons in the editor; the rest are library-only. */
export const EDITOR_PRESET_IDS = ['loop', 'brandmark', 'r', 'sizes', 'empty']
